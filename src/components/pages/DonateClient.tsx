    ...
    <>
      ...
      <section className="relative min-h-[55vh] flex items-end pb-20 px-8 overflow-hidden"
        ...
        <div className="absolute right-0 top-0 w-[40vw] h-full pointer-events-none opacity-15"
          style={{ background: "radial-gradient(ellipse at 80% 40%,#C9A96E,transparent 60%)" }} />
      ...
      <section className="py-28 px-8" style={{ background: "#ffffff" }}>
        <div className="max-w-6xl mx-auto">
            ...
            {c.causes.map((cause, i) => (
              <Reveal key={i} delay={i * 0.1} direction="up">
                <div className="group flex flex-col h-full p-8 rounded-2xl border border-transparent
                  hover:border-forest/35 hover:shadow-[0_8px_40px_rgba(35,83,71,.1)] transition-all duration-300"
          ...
          <Reveal direction="scale">
            <div className="max-w-2xl mx-auto rounded-3xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,.25)]"
              style={{ background: "linear-gradient(135deg,#051F20,#0B2B26 55%,#163832)" }}>
              <div className="p-8 lg:p-10">
                ...
                <div className="grid grid-cols-2 gap-4 mb-7">
                  <div>
                    ...
                    <div className="space-y-2">
                      {[
                        { label: "Stripe",  desc: c.stripeDesc,  Icon: CreditCard, color: "#635BFF" },
                        { label: "PayPal",  desc: c.paypalDesc,  Icon: Wallet,     color: "#003087" },
                      ].map(m => (
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {[
                        { label: "TeleBirr", desc: c.telebirrDesc, Icon: Smartphone, color: "#00BCD4" },
                        { label: "Chapa",    desc: c.chapaDesc,    Icon: Globe,      color: "#2E7D32" },
                      ].map(m => (
                        <button key={m.label} className="w-full flex items-center gap-3 p-3 rounded-xl border border-sage/10 hover:border-sage/30 transition-all group">
                          <m.Icon size={16} strokeWidth={1.6} style={{ color: m.color }} />
                          <div className="text-left">
                ...
                <button className={clsx("w-full flex items-center justify-center gap-2 py-4 rounded-xl font-semibold",
                  ...
                  style={{ background: "linear-gradient(135deg,#D4A853,#C9A96E)", color: "#051F20",
