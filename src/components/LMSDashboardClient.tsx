...
export default function LMSDashboardClient({ locale, c }: { locale: string; c: Content }) {
  ...
  return (
    <div style={{ background: "linear-gradient(135deg, #051F20 0%, #0B2B26 50%, #163832 100%)", minHeight: "100vh", padding: "2rem" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        {/* Welcome Card */}
        <Reveal>
          <div style={{ background: "rgba(11,43,38,.5)", borderRadius: 20, padding: "2rem", border: "1px solid rgba(142,182,155,.12)", backdropFilter: "blur(10px)", marginBottom: "2rem" }}>
        ...
        {/* Course Progress */}
        <Reveal delay={0.4}>
          <div style={{ background: "rgba(11,43,38,.5)", borderRadius: 20, padding: "2rem", border: "1px solid rgba(142,182,155,.12)", backdropFilter: "blur(10px)" }}>
